...
const locales = {
  zh: {
    ...
    menu_fullscreen: '全屏',
    menu_help: '帮助',
    menu_about: '关于 dshd Red',
    menu_language: '语言',
    menu_lang_zh: '中文',
    menu_lang_en: 'English',

    // 关于对话框
    about_title: '关于 dshd Red',
    about_message: 'dshd Red v1.0.0',
    about_detail: 'dshd Red — DeepSeek Harness 桌面端\n\n基于 Electron 的原生桌面应用。\n支持远程连接，dshd Blue（手机端）可通过连接码/二维码访问。',
    ...
    // 连接窗口
    conn_title: '远程连接',
    conn_subtitle: '在 dshd Blue App 中输入连接码，或扫描二维码',
  ...
  en: {
    ...
    menu_help: 'Help',
    menu_about: 'About dshd Red',
    menu_language: 'Language',
    menu_lang_zh: '中文',
    menu_lang_en: 'English',

    about_title: 'About dshd Red',
    about_message: 'dshd Red v1.0.0',
    about_detail: 'dshd Red — DeepSeek Harness desktop GUI\n\nA native Electron desktop app.\nRemote connection via dshd Blue (mobile) using connection code/QR.',
    ...
    conn_subtitle: 'Enter the connection code in dshd Blue app, or scan the QR code',
