...
| Integration packs (dshd Yellow) — pack skills/plugins/MCP/presets/models/patches/soul into reference-only manifests; on-demand hash-deduped downloads; load into new sessions/forks | standalone [id5463/dshd-yellow](https://github.com/id5463/dshd-yellow) | **shipped** (sidebar → Packs; Yellow embedded in Red) |
